defmodule RPNCalculatorInspection do
  @spec start_reliability_check(function(), number()) :: %{input: number(), pid: pid()}
  ...
  def reliability_check(calculator, inputs) do
    previous_process_flag = Process.flag(:trap_exit, true)
    ...
    Process.flag(:trap_exit, previous_process_flag)
    results
  end

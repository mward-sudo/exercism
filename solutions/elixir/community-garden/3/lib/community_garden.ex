...
defmodule CommunityGarden do
  ...
  def register(pid, register_to) do
    ...
    Agent.update(pid, fn registrations -> [new_plot | registrations] end)

    new_plot
  end

  def release(pid, plot_id) do
    Agent.update(pid, &for(plot <- &1, do: maybe_release_plot(plot, plot_id)))
  end
  ...
  defp maybe_release_plot(%Plot{plot_id: p_id} = plot, plot_id) when p_id == plot_id,

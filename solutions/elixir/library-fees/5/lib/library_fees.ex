defmodule LibraryFees do
  ...
  def days_late(planned_return_date, actual_return_datetime) do
    ...
    |> ensure_integer_is_non_negative()
  end
  ...
  @spec ensure_integer_is_non_negative(value :: integer()) :: non_neg_integer()
  defp ensure_integer_is_non_negative(value) when value >= 0, do: value
  defp ensure_integer_is_non_negative(_value), do: 0
end
